...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        if (filterType === 'client-extract') {
            ...
            const personName = searchParams.get('personName') || 'all';
