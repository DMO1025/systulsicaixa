...
import type { DailyLogEntry, PeriodData, EventosPeriodData, GeneralReportViewData, ReportData, PeriodId, PeriodReportViewData, DailyCategoryDataItem, FaturadoItem, ConsumoInternoItem, UnifiedPersonTransaction } from '@/lib/types';
